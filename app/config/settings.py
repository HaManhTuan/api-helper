...
class Settings(BaseSettings):
    ...
    # Project settings
    PROJECT_NAME: str = "API Helper Application"
    PROJECT_DESCRIPTION: str = "API Helper Application"
    ...
    # JWT Auth
    JWT_SECRET_KEY: str = "change_this_to_a_secure_secret"  # should be overridden in .env
