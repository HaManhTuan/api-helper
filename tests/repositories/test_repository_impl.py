...
class TestRepositoryImpl:
    ...
    async def test_get_all_users(self):
        ...
        mock_result.scalars.return_value.all.return_value = [
            User(id="1", email="user1@example.com", phone="0900000011", role="customer", status="active"),
            User(id="2", email="user2@example.com", phone="0900000012", role="customer", status="active"),
        ]
        mock_db.execute.return_value = mock_result
